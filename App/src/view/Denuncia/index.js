...
export default function Denuncia() {
    ...
    function sendWhatsapp() {
        registrarDenuncia(nomeEvento, localizacao, horario, nomeArquivo, arquivo.base64 ? arquivo.base64 : arquivo.uri);
        const message = `Evento: *${nomeEvento}*\n\nData da aglomeração: *${horario}*\n\nLocalização: *${localizacao}*`;
    ...
    var screen_form = (
        <View style={styles.container}>
            ...
            <View style={{flexDirection: 'row', justifyContent: "space-between", alignItems: 'center', marginTop: 24 }}>
                <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#e02041', borderRadius: 8, height: 80, width: '100%', justifyContent: 'space-evenly', alignItems: 'center' }} onPress={() => { setEnviandoDenuncia(true) }}>
    ...
    var screen_done = (
        <View style={styles.container}>
            <View style={{
                ...
                <Feather style={{}} name='check-circle' size={150} color={'#00cc00'} />
                <Text style={{  marginBottom: 14, fontSize: 32, color: '#00cc00', height: 34, fontWeight: 'bold'}}>Denuncia enviada</Text>
                <Text style={{  marginTop:20, marginBottom: 20, fontSize: 14, color: '#000', height: 34}}>Agradecemos pelo suporte para combater a atual pandemia causada pela COVID-19</Text>
                
                <View style={styles.actions}>
                    <TouchableOpacity style={styles.action} onPress={() => {sendWhatsapp()}}>
                        <Feather style={{justifyContent: 'flex-start'}} name='share-2' size={20} color={'#FFF'} />
                    </TouchableOpacity>
                </View>
            </View>
        </View>
